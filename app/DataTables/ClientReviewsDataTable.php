...
class ClientReviewsDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\ClientReviewsDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ClientReviewsDataTable $model)
    {
        // return $model->newQuery();
        $data = Review::with('product')->where('user_id', auth()->user()->id)->latest()->get();
