                        ...
                        <tr>
                          <th>
                            <div class="d-inline-block align-middle">
                              ...
                              <img src="{{ $image === "noImage.jpg" ? "/storage/$image" : "/storage/product_images/$image" }}" class="card-img" style="width: 100px">
                            </div>
                            <div class="d-inline-block align-middle">
                          ...
                          <td>
                            <form action="{{ route('cart.update', $item->id) }}" method="POST">
                              @csrf
                              @method('PUT')
                                <input name="quantity" type="number" min="1" value="{{ $item->quantity }}" class="form-control" style="width:70px">
                            </form>
                          </td>
              ...
              <div class="row valider-panier mt-5">
                <div class="col">
                  ...
                  <div class="d-flex justify-content-center">
                    <a class="btn btn-primary" href="{{ route('cart.delete_item',1) }}"> Valider mon panier</a>
                  </div>
                </div>
              </div>
