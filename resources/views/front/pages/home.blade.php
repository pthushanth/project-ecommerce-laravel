      ...
      <div class="container-fluid px-5">
        <h2 class="text-center">Exclusive Products</h2>
          <ul class="nav nav-tabs justify-content-center" role="tablist">
              <li class="nav-item">
                <a class="nav-link btn showProductDiv" target="newProduct" data-toggle="tab" role="tab" aria-controls="special" aria-selected="false"  onclick="showProductDiv(this.target)">New products</a>
              </li>
              <li class="nav-item">
                <a class="nav-link btn showProductDiv" target="topRated" data-toggle="tab" role="tab" aria-controls="special" aria-selected="false"  onclick="showProductDiv(this.target)">Top rated</a>

              </li>
              <li class="nav-item">
                <a class="nav-link btn showProductDiv" target="bestSeller" data-toggle="tab" role="tab" aria-controls="special" aria-selected="false"  onclick="showProductDiv(this.target)">Best seller</a>
              </li>
              <li class="nav-item">
        ...
        <div class="glider-contain">
          ...
          <div id="topRated" class="productDiv">
            <div class="glider">
              <div class="card">
                <img class="card-img-top" src="{{ asset('images/test/iphone12.jpg') }}" >
                <div class="card-body text-center">
              ...
              <div class="masque">
                  <div class="container align-self-center">
                      <div class="row mt-5 justify-content-center">
                          <div class="col-12"> <h4 class="text-center">OFFRE SPECIAL -25%</h4></div>
                          <div class="col-12 mt-3 text-center"><a href="{{''}}" class="btn btn-primary button-cta">Profitez maintenant</a></div>
                      </div>
                  </div>
              </div>
          </div>
