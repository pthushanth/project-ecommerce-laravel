                    ...
                    <div class="card-body card-block">
                        <form method="POST" action="{{route('admin.products.update',$product->slug)}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="price" name="price" value="{{ old('name',$product->price) }}"
                                ...
                                <div class="input-group">
                                    <select name="category" id="category"
                                        ...
                                        <option value="{{ $category->id }}"
                                            {{ old('category') == $category->id ||  $product->category->id == $category->id ? 'selected' : '' }}>
                                ...
                                <div class="input-group">
                                    <select name="brand" id="brand"
                                        ...
                                        <option value="{{ $brand->id }}"
                                            {{ old('brand') == $brand->id ||  $product->brand->id == $brand->id ? 'selected' : '' }}>
                                            {{ $brand->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div id="imageField">
                                    ...
                                    <img src="{{ asset($product->getImageUrl($image)) }}" width="200px">
                                    @endforeach
