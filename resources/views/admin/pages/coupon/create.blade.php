                        ...
                        <form method="POST" action="{{route('admin.coupons.update',$coupon->id)}}"
                            ...
                            <form method="POST" action="{{route('admin.coupons.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="percentage" name="discount_type"
                                        value="pourcentage" @if(@isset($coupon))
                                        {{$coupon->discount_type == "pourcentage" ? 'checked' : ''}} @endif>
                                    <label class="form-check-label" for="percentage">Pourcentage</label></label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="remise" name="discount_type"
                                        value="fixed" @if(@isset($coupon))
                                        {{$coupon->discount_type == "fixed" ? 'checked' : ''}} @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="start" name="start"
                                            value="{{ old('start',$coupon->start ?? '') }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="end" name="end"
                                            value="{{ old('end',$coupon->end ?? '') }}" class="form-control">
                                    </div>
                                </div>
